...
The GrowthModeling repository contains a Java [utility](https://github.com/AGSArchitect/GrowthModeling/blob/main/GrowthModeling/src/main/java/com/cardioai/tools/modeling/GrowthModeling.java) designed to estimate business growth based on various input conditions. The utility was developed by Group 2 (Cohort 20024) as part of the Professional Certificate Program in Product Management from the Massachusetts Institute of Technology (MIT).
...
The following is a JSON-serialized configuration file containing the default values for all coefficients.
